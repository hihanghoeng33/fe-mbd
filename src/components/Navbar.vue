...
<template>
    <nav class="bg-white shadow-sm fixed top-0 left-0 right-0 z-20 px-6 py-4 flex items-center justify-between gap-x-4">
        <div class="flex items-center gap-x-4">
            ...
            <div class="text-lg be-vietnam-pro-bold text-gray-800 max-w-64">ITS Research & Collaboration Center</div>
        </div>
        <div class="flex items-center gap-x-8">
            ...
            <div class="w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center cursor-pointer select-none focus:outline-none hover:outline-none hover:ring-0">
            <img @click="navigate" src="/profile-picture.png" alt="Profile Picture" class="w-auto h-auto rounded-full">
            </div>
        </div>
    </nav>
</template>
